...
public extension View {
    ...
    func disabled4(_ flag: Bool = true) -> some View { disabled(flag, opacity: 0.4) }
    func disabled5(_ flag: Bool = true) -> some View { disabled(flag, opacity: 0.5) }
    func disabled6(_ flag: Bool = true) -> some View { disabled(flag, opacity: 0.6) }
