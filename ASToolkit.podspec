...
Pod::Spec.new do |s|
  ...
  s.author             = { "Andrzej Semeniuk" => andrzejsemeniuk@gmail.com" }
  # Or just: s.author    = "Andrzej Semeniuk"
  # s.authors            = { "Andrzej Semeniuk" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Andrzej Semeniuk"
  ...
  s.source_files  = "ASToolkit", "ASToolkit/**/*.{h,m,swift}"
